...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/14 19:36:55 by vbespalk          #+#    #+#             */
/*   Updated: 2019/05/14 19:36:57 by vbespalk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_aabb		*ft_init_aabb(t_vector min, t_vector max)
{
	...
	{
		bbx->bounds[0] = (t_vector) {-10000000000000, -10000000000000,
							-10000000000000};
		bbx->bounds[1] = (t_vector) {10000000000000, 10000000000000,
							10000000000000};
	}
	else
	{
...
t_vector	ft_collide_aabb(void *fig, t_vector origin, t_vector direct)
{
	...
	return (t[0] > FLT_MIN ? origin + ft_3_vector_scale(direct, t[0]) :
		ZERO_PNT);
}
